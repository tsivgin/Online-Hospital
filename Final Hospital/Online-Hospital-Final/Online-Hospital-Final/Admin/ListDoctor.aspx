...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-4">
        <asp:Panel runat="server" ID="list" Visible="true">
            ...
            <div class="active">
                ...
                <div class="active">
                    ...
                    <asp:CheckBoxList ID="rbtn1_doctor" BorderStyle="Solid" TextAlign="Left" runat="server" />
                ...
                <div class="main-login main-center">
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                <asp:DropDownList runat="server" ID="gender_add" CssClass="form-control"></asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator7" ForeColor="Red" ControlToValidate="gender_add" ErrorMessage="Please fill the box."></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
        ...
        <asp:Panel runat="server" ID="edit_doctor2" Visible="false">
            ...
            <div class="isa_error">
                <i class="fa fa-times-circle"></i>
                <asp:Label ID="Label2" runat="server" ForeColor="Red" Text="Kayıt esnasında bir hata oluştur, lütfen girdiğiniz bilgileri kontrol ederek tekrar deneyiniz." Visible="false"></asp:Label>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" ForeColor="Red" ControlToValidate="gender_edit" ErrorMessage="Please fill the box."></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
