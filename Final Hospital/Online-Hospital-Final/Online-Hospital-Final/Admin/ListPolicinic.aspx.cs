...
namespace Online_Hospital.Admin
{
    ...
    public partial class ListPolicinic : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// If not İspostback load fetchdata
        /// </summary>
        ...
        protected void registerbtn_Click(object sender, EventArgs e)
        {
            ...
            if (PolicinicName.Text != "" || Address.Text != "" || Phone.Text != "")
            {
                ...
                SqlCommand cmd = db.MySqlCommand(sorgu);
        ...
        /// <summary>
        /// go edit policinic page of selection policinic
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void edit_policinic_Click(object sender, EventArgs e)
        {
            if (rbtnl_policinic.SelectedItem != null)
            {
        ...
        /// <summary>
        /// Save edit policinic information
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
