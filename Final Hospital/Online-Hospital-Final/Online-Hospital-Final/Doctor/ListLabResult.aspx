<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/Doctor.Master" AutoEventWireup="true" CodeBehind="ListLabResult.aspx.cs" Inherits="Online_Hospital.Doctor.ListLabResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="padding-top: 8em">
        ...
        <%-- LabResult --%>
        <asp:Panel runat="server" ID="calender" Visible="false">
            <center>
                <div class="row">
                    <div class="container">
                        <div class="col-md-12" style="text-align: center">
                            <h2>List Appointment</h2>
                            <asp:GridView CssClass="table table-hover table-striped" runat="server" ID="labresult" >
                            </asp:GridView>
                        </div>
                    </div>
                </div>
