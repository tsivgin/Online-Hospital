<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online_Hospital.Admin._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-4">
        ...
        <asp:Panel runat="server" ID="delete_personel" Visible="false">
        </asp:Panel>
