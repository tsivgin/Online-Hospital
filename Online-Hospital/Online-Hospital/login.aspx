                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <%--<asp:RequiredFieldValidator ID="TC" runat="server" ControlToValidate="txt_TC"  ForeColor="Red" ErrorMessage="Please fill the box."></asp:RequiredFieldValidator>--%>
                                    </div>
                                    <div class="form-group">
                                        <%--ID="txt_Password"--%>
                                        <asp:TextBox ID="Password" runat="server" placeholder="PASSWORD" TabIndex="1" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator ID="Password" runat="server" ControlToValidate="txt_Password" ForeColor="Red" ErrorMessage="Please fill the box."></asp:RequiredFieldValidator>--%>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                ...
                                                <%--<asp:Button ID="loginForAdmin" runat="server" Text="Login" OnClick="loginForAdmin_Click" /><br />--%>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
